...
import { Box, Flex, Text, Button, GridItem, Grid, SimpleGrid, Input, InputGroup, InputRightElement, IconButton, RangeSlider, RangeSliderTrack, RangeSliderFilledTrack, RangeSliderThumb, Image, Avatar, AspectRatio } from '@chakra-ui/react'
import { useParams } from 'react-router-dom'
import "./SingleCar.css"

import { FcApproval, FcHighPriority, FcBusinessman } from 'react-icons/fc'
import { BsDropletHalf ,BsJournalBookmark } from 'react-icons/bs'
...
//    useEffect(()=>{
//     getData(`http://localhost:8080/cars/${car_id}`).then((res)=>
//      setData(res.data)
//      )
    ...
    return (
        <div className="mainDiv">
            <Flex h="100%" w="100%" justifyContent="space-around" >
                ...
                <Box w="63%" border="1px solid black">
                    <Box   boxShadow="rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px">
                        <Box h="250px" w="70%" margin="auto">
                            <Image h="100%" w="100%" src="https://zoomcar-assets.zoomcar.com/photographs/original/13284dce101cd7020c977103e2cb5f33bee3b0e9.png?1663874479" />
                    ...
                    <Box className='secondBox' borderRadius="20px"  h="auto" marginTop="25px" boxShadow= "rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px">
                        <SimpleGrid gap={2} columns={{ base: 1, sm: 1, md: 1, lg: 2 }}>
                            <Box h="80px" >
                                ...
                                <Box marginLeft="15px">
                                    <Text fontSize="2xl" fontWeight="600" color="#1F1F1F" fontFamily="Inter, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, Sans-Serif">Suzuki Ignis MT Petrol</Text>

                                </Box>
                                <Box h="auto" display="flex" marginLeft="15px" >
                                    <Box h="100%" w="auto" >
                                        <Text fontSize="md" color="#A8A8A8" fontFamily="apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif"> transmission</Text>
                                    </Box>
                                    <Box h="100%" w="auto" marginLeft="10px">
                                        <Text fontSize="md" color="#A8A8A8" fontFamily="apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif">fueltype</Text>
                                    </Box>
                                    <Box h="100%" w="auto" marginLeft="10px">
                                        <Text fontSize="md" color="#A8A8A8" fontFamily="apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif">Seats</Text>
                                    </Box>
                        ...
                        <Box  h="40px"  >
                            <Box margin="auto" display="flex" w="auto" h="40px"  >
                                ...
                                <Text fontSize='15px' marginLeft="2px">4.43</Text>
